...
import telega/model.{
  ...
  type InlineKeyboardMarkup, type IntOrString, type LinkPreviewOptions,
  type Message as ModelMessage, type MessageEntity, type ReplyKeyboardMarkup,
  type ReplyParameters, type SwitchInlineQueryChosenChat,
}
...
pub fn encode_menu_button(menu_button: model.MenuButton) -> Json {
  case menu_button {
    model.MenuButtonCommandsMenuButton(model.MenuButtonCommands(..)) ->
      model.json_object_filter_nulls([#("type", json.string("commands"))])
    model.MenuButtonWebAppMenuButton(model.MenuButtonWebApp(
      ...
      model.json_object_filter_nulls([
        ...
        #("web_app", model.encode_web_app_info(web_app)),
      ])
...
pub fn encode_inline_keyboard_markup(
  ...
  model.json_object_filter_nulls([inline_keyboard])
}
...
pub fn encode_inline_keyboard_button(
  ...
  let web_app = #(
    "web_app",
    json.nullable(inline_keyboard_button.web_app, model.encode_web_app_info),
  )
  let login_url = #(
    "login_url",
    json.nullable(inline_keyboard_button.login_url, model.encode_login_url),
  )
