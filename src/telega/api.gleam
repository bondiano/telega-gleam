...
pub fn set_chat_administrator_custom_title(config config, parameters parameters) {
  let body_json =
...
pub fn ban_chat_sender_chat(config config, parameters parameters) {
...
pub fn unban_chat_sender_chat(config config, parameters parameters) {
...
pub fn set_chat_permissions(config config, parameters parameters) {
...
pub fn export_chat_invite_link(config config, parameters parameters) {
...
pub fn create_chat_invite_link(config config, parameters parameters) {
...
pub fn edit_chat_invite_link(config config, parameters parameters) {
...
pub fn edit_chat_subscription_invite_link(config config, parameters parameters) {
  let body_json =
...
pub fn revoke_chat_invite_link(config config, parameters parameters) {
...
pub fn approve_chat_join_request(config config, parameters parameters) {
...
pub fn decline_chat_join_request(config config, parameters parameters) {
...
pub fn set_chat_photo(config config, parameters parameters) {
...
pub fn delete_chat_photo(config config, parameters parameters) {
