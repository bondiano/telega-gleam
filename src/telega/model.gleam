...
pub fn chat_full_info_decoder() -> decode.Decoder(ChatFullInfo) {
  ...
  use can_send_gift <- decode.field(
    "can_send_gift",
    decode.optional(decode.bool),
  )
...
pub fn encode_paid_media_info(paid_media_info: PaidMediaInfo) -> Json {
  json_object_filter_nulls([
    ...
    #("paid_media", json.array(paid_media_info.paid_media, encode_paid_media)),
  ])
}
...
pub fn encode_paid_media_photo(paid_media_photo: PaidMediaPhoto) -> Json {
  json_object_filter_nulls([
    ...
    #("photo", json.array(paid_media_photo.photo, encode_photo_size)),
  ])
}
...
pub fn encode_poll_answer(poll_answer: PollAnswer) -> Json {
  json_object_filter_nulls([
    ...
    #("option_ids", json.array(poll_answer.option_ids, json.int)),
  ])
}
...
pub fn encode_poll(poll: Poll) -> Json {
  json_object_filter_nulls([
    ...
    #("options", json.array(poll.options, encode_poll_option)),
...
pub fn encode_background_fill_freeform_gradient(
  ...
  json_object_filter_nulls([
    ...
    #("colors", json.array(background_fill_freeform_gradient.colors, json.int)),
  ])
}
...
pub fn encode_users_shared(users_shared: UsersShared) -> Json {
  json_object_filter_nulls([
    ...
    #("users", json.array(users_shared.users, encode_shared_user)),
  ])
}
...
pub fn encode_video_chat_participants_invited(
  ...
  json_object_filter_nulls([
    #("users", json.array(video_chat_participants_invited.users, encode_user)),
  ])
}
...
pub fn encode_giveaway(giveaway: Giveaway) -> Json {
  json_object_filter_nulls([
    #("chats", json.array(giveaway.chats, encode_chat)),
...
pub fn encode_giveaway_winners(giveaway_winners: GiveawayWinners) -> Json {
  json_object_filter_nulls([
    ...
    #("winners", json.array(giveaway_winners.winners, encode_user)),
    #(
      "additional_chat_count",
...
pub fn encode_user_profile_photos(
  ...
  json_object_filter_nulls([
    ...
    #(
      "photos",
      json.array(user_profile_photos.photos, fn(inner_list) {
...
pub fn encode_reply_keyboard_markup(
  ...
  json_object_filter_nulls([
    #(
      "keyboard",
      json.array(reply_keyboard_markup.keyboard, fn(inner_list) {
...
pub fn encode_inline_keyboard_markup(
  ...
  json_object_filter_nulls([
    #(
      "inline_keyboard",
      json.array(inline_keyboard_markup.inline_keyboard, fn(inner_list) {
  ...
  json_object_filter_nulls([
    ...
    #(
      ...
      json.array(
        ...
        encode_business_opening_hours_interval,
      ),
    ),
  ])
}
...
pub fn encode_message_reaction_updated(
  ...
  json_object_filter_nulls([
    ...
    #(
      "old_reaction",
      json.array(message_reaction_updated.old_reaction, encode_reaction_type),
    ),
    #(
      "new_reaction",
      json.array(message_reaction_updated.new_reaction, encode_reaction_type),
    ),
  ])
}
...
pub fn encode_user_chat_boosts(user_chat_boosts: UserChatBoosts) -> Json {
  json_object_filter_nulls([
    #("boosts", json.array(user_chat_boosts.boosts, encode_chat_boost)),
  ])
}
...
pub fn encode_business_messages_deleted(
  ...
  json_object_filter_nulls([
    ...
    #(
      "message_ids",
      json.array(business_messages_deleted.message_ids, json.int),
    ),
  ])
}
...
pub fn encode_sticker_set(sticker_set: StickerSet) -> Json {
  json_object_filter_nulls([
    ...
    #("stickers", json.array(sticker_set.stickers, encode_sticker)),
...
pub fn encode_input_sticker(input_sticker: InputSticker) -> Json {
  json_object_filter_nulls([
    ...
    #("emoji_list", json.array(input_sticker.emoji_list, json.string)),
    #(
      "mask_position",
...
pub fn encode_gifts(gifts: Gifts) -> Json {
  json_object_filter_nulls([#("gifts", json.array(gifts.gifts, encode_gift))])
}
...
pub fn encode_input_invoice_message_content(
  ...
  json_object_filter_nulls([
    ...
    #(
      "prices",
      json.array(input_invoice_message_content.prices, encode_labeled_price),
    ),
    #(
      "max_tip_amount",
...
pub fn encode_shipping_option(shipping_option: ShippingOption) -> Json {
  json_object_filter_nulls([
    ...
    #("prices", json.array(shipping_option.prices, encode_labeled_price)),
  ])
}
...
pub fn encode_star_transactions(star_transactions: StarTransactions) -> Json {
  json_object_filter_nulls([
    #(
      "transactions",
      json.array(star_transactions.transactions, encode_star_transaction),
    ),
  ])
}
...
pub fn encode_passport_data(passport_data: PassportData) -> Json {
  json_object_filter_nulls([
    #("data", json.array(passport_data.data, encode_encrypted_passport_element)),
...
pub fn encode_passport_element_error_files(
  ...
  json_object_filter_nulls([
    ...
    #(
      "file_hashes",
      json.array(passport_element_error_files.file_hashes, json.string),
    ),
...
pub fn encode_game(game: Game) -> Json {
  json_object_filter_nulls([
    ...
    #("photo", json.array(game.photo, encode_photo_size)),
...
pub fn encode_maybe_inaccessible_message(
  ...
  case value {
    MessageMaybeInaccessibleMessage(inner_value) -> {
      json.object([
        #("type", json.string("message")),
        #("value", encode_message(inner_value)),
      ])
    }
    InaccessibleMessageMaybeInaccessibleMessage(inner_value) -> {
      json.object([
        #("type", json.string("inaccessible_message")),
        #("value", encode_inaccessible_message(inner_value)),
      ])
    }
  }
}
...
pub fn encode_message_origin(value: MessageOrigin) -> Json {
  case value {
    MessageOriginUserMessageOrigin(inner_value) -> {
      json.object([
        #("type", json.string("message_origin_user")),
        #("value", encode_message_origin_user(inner_value)),
      ])
    }
    MessageOriginHiddenUserMessageOrigin(inner_value) -> {
      json.object([
        #("type", json.string("message_origin_hidden_user")),
        #("value", encode_message_origin_hidden_user(inner_value)),
      ])
    }
    MessageOriginChatMessageOrigin(inner_value) -> {
      json.object([
        #("type", json.string("message_origin_chat")),
        #("value", encode_message_origin_chat(inner_value)),
      ])
    }
    MessageOriginChannelMessageOrigin(inner_value) -> {
      json.object([
        #("type", json.string("message_origin_channel")),
        #("value", encode_message_origin_channel(inner_value)),
      ])
    }
  }
}
...
pub fn encode_paid_media(value: PaidMedia) -> Json {
  case value {
    PaidMediaPreviewPaidMedia(inner_value) -> {
      json.object([
        #("type", json.string("paid_media_preview")),
        #("value", encode_paid_media_preview(inner_value)),
      ])
    }
    PaidMediaPhotoPaidMedia(inner_value) -> {
      json.object([
        #("type", json.string("paid_media_photo")),
        #("value", encode_paid_media_photo(inner_value)),
      ])
    }
    PaidMediaVideoPaidMedia(inner_value) -> {
      json.object([
        #("type", json.string("paid_media_video")),
        #("value", encode_paid_media_video(inner_value)),
      ])
    }
  }
}
...
pub fn encode_background_fill(value: BackgroundFill) -> Json {
  case value {
    BackgroundFillSolidBackgroundFill(inner_value) -> {
      json.object([
        #("type", json.string("background_fill_solid")),
        #("value", encode_background_fill_solid(inner_value)),
      ])
    }
    BackgroundFillGradientBackgroundFill(inner_value) -> {
      json.object([
        #("type", json.string("background_fill_gradient")),
        #("value", encode_background_fill_gradient(inner_value)),
      ])
    }
    BackgroundFillFreeformGradientBackgroundFill(inner_value) -> {
      json.object([
        #("type", json.string("background_fill_freeform_gradient")),
        #("value", encode_background_fill_freeform_gradient(inner_value)),
      ])
    }
  }
}
...
pub fn encode_background_type(value: BackgroundType) -> Json {
  case value {
    BackgroundTypeFillBackgroundType(inner_value) -> {
      json.object([
        #("type", json.string("background_type_fill")),
        #("value", encode_background_type_fill(inner_value)),
      ])
    }
    BackgroundTypeWallpaperBackgroundType(inner_value) -> {
      json.object([
        #("type", json.string("background_type_wallpaper")),
        #("value", encode_background_type_wallpaper(inner_value)),
      ])
    }
    BackgroundTypePatternBackgroundType(inner_value) -> {
      json.object([
        #("type", json.string("background_type_pattern")),
        #("value", encode_background_type_pattern(inner_value)),
      ])
    }
    BackgroundTypeChatThemeBackgroundType(inner_value) -> {
      json.object([
        #("type", json.string("background_type_chat_theme")),
        #("value", encode_background_type_chat_theme(inner_value)),
      ])
    }
  }
}
...
pub fn encode_chat_member(value: ChatMember) -> Json {
  case value {
    ChatMemberOwnerChatMember(inner_value) -> {
      json.object([
        #("type", json.string("chat_member_owner")),
        #("value", encode_chat_member_owner(inner_value)),
      ])
    }
    ChatMemberAdministratorChatMember(inner_value) -> {
      json.object([
        #("type", json.string("chat_member_administrator")),
        #("value", encode_chat_member_administrator(inner_value)),
      ])
    }
    ChatMemberMemberChatMember(inner_value) -> {
      json.object([
        #("type", json.string("chat_member_member")),
        #("value", encode_chat_member_member(inner_value)),
      ])
    }
    ChatMemberRestrictedChatMember(inner_value) -> {
      json.object([
        #("type", json.string("chat_member_restricted")),
        #("value", encode_chat_member_restricted(inner_value)),
      ])
    }
    ChatMemberLeftChatMember(inner_value) -> {
      json.object([
        #("type", json.string("chat_member_left")),
        #("value", encode_chat_member_left(inner_value)),
      ])
    }
    ChatMemberBannedChatMember(inner_value) -> {
      json.object([
        #("type", json.string("chat_member_banned")),
        #("value", encode_chat_member_banned(inner_value)),
      ])
    }
  }
}
...
pub fn encode_reaction_type(value: ReactionType) -> Json {
  case value {
    ReactionTypeEmojiReactionType(inner_value) -> {
      json.object([
        #("type", json.string("reaction_type_emoji")),
        #("value", encode_reaction_type_emoji(inner_value)),
      ])
    }
    ReactionTypeCustomEmojiReactionType(inner_value) -> {
      json.object([
        #("type", json.string("reaction_type_custom_emoji")),
        #("value", encode_reaction_type_custom_emoji(inner_value)),
      ])
    }
    ReactionTypePaidReactionType(inner_value) -> {
      json.object([
        #("type", json.string("reaction_type_paid")),
        #("value", encode_reaction_type_paid(inner_value)),
      ])
    }
  }
}
...
pub fn encode_bot_command_scope(value: BotCommandScope) -> Json {
  case value {
    BotCommandScopeDefaultBotCommandScope(inner_value) -> {
      json.object([
        #("type", json.string("bot_command_scope_default")),
        #("value", encode_bot_command_scope_default(inner_value)),
      ])
    }
    BotCommandScopeAllPrivateChatsBotCommandScope(inner_value) -> {
      json.object([
        #("type", json.string("bot_command_scope_all_private_chats")),
        #("value", encode_bot_command_scope_all_private_chats(inner_value)),
      ])
    }
    BotCommandScopeAllGroupChatsBotCommandScope(inner_value) -> {
      json.object([
        #("type", json.string("bot_command_scope_all_group_chats")),
        #("value", encode_bot_command_scope_all_group_chats(inner_value)),
      ])
    }
    BotCommandScopeAllChatAdministratorsBotCommandScope(inner_value) -> {
      json.object([
        #("type", json.string("bot_command_scope_all_chat_administrators")),
        #(
          "value",
    ...
    BotCommandScopeChatBotCommandScope(inner_value) -> {
      json.object([
        #("type", json.string("bot_command_scope_chat")),
        #("value", encode_bot_command_scope_chat(inner_value)),
      ])
    }
    BotCommandScopeChatAdministratorsBotCommandScope(inner_value) -> {
      json.object([
        #("type", json.string("bot_command_scope_chat_administrators")),
        #("value", encode_bot_command_scope_chat_administrators(inner_value)),
      ])
    }
    BotCommandScopeChatMemberBotCommandScope(inner_value) -> {
      json.object([
        #("type", json.string("bot_command_scope_chat_member")),
        #("value", encode_bot_command_scope_chat_member(inner_value)),
      ])
    }
  }
}
...
pub fn encode_menu_button(value: MenuButton) -> Json {
  case value {
    MenuButtonCommandsMenuButton(inner_value) -> {
      json.object([
        #("type", json.string("menu_button_commands")),
        #("value", encode_menu_button_commands(inner_value)),
      ])
    }
    MenuButtonWebAppMenuButton(inner_value) -> {
      json.object([
        #("type", json.string("menu_button_web_app")),
        #("value", encode_menu_button_web_app(inner_value)),
      ])
    }
    MenuButtonDefaultMenuButton(inner_value) -> {
      json.object([
        #("type", json.string("menu_button_default")),
        #("value", encode_menu_button_default(inner_value)),
      ])
    }
  }
}
...
pub fn encode_chat_boost_source(value: ChatBoostSource) -> Json {
  case value {
    ChatBoostSourcePremiumChatBoostSource(inner_value) -> {
      json.object([
        #("type", json.string("chat_boost_source_premium")),
        #("value", encode_chat_boost_source_premium(inner_value)),
      ])
    }
    ChatBoostSourceGiftCodeChatBoostSource(inner_value) -> {
      json.object([
        #("type", json.string("chat_boost_source_gift_code")),
        #("value", encode_chat_boost_source_gift_code(inner_value)),
      ])
    }
    ChatBoostSourceGiveawayChatBoostSource(inner_value) -> {
      json.object([
        #("type", json.string("chat_boost_source_giveaway")),
        #("value", encode_chat_boost_source_giveaway(inner_value)),
      ])
    }
  }
}
...
pub fn encode_input_media(value: InputMedia) -> Json {
  case value {
    InputMediaAnimationInputMedia(inner_value) -> {
      json.object([
        #("type", json.string("input_media_animation")),
        #("value", encode_input_media_animation(inner_value)),
      ])
    }
    InputMediaDocumentInputMedia(inner_value) -> {
      json.object([
        #("type", json.string("input_media_document")),
        #("value", encode_input_media_document(inner_value)),
      ])
    }
    InputMediaAudioInputMedia(inner_value) -> {
      json.object([
        #("type", json.string("input_media_audio")),
        #("value", encode_input_media_audio(inner_value)),
      ])
    }
    InputMediaPhotoInputMedia(inner_value) -> {
      json.object([
        #("type", json.string("input_media_photo")),
        #("value", encode_input_media_photo(inner_value)),
      ])
    }
    InputMediaVideoInputMedia(inner_value) -> {
      json.object([
        #("type", json.string("input_media_video")),
        #("value", encode_input_media_video(inner_value)),
      ])
    }
  }
}
...
pub fn encode_input_paid_media(value: InputPaidMedia) -> Json {
  case value {
    InputPaidMediaPhotoInputPaidMedia(inner_value) -> {
      json.object([
        #("type", json.string("input_paid_media_photo")),
        #("value", encode_input_paid_media_photo(inner_value)),
      ])
    }
    InputPaidMediaVideoInputPaidMedia(inner_value) -> {
      json.object([
        #("type", json.string("input_paid_media_video")),
        #("value", encode_input_paid_media_video(inner_value)),
      ])
    }
  }
}
...
pub fn encode_inline_query_result(value: InlineQueryResult) -> Json {
  case value {
    InlineQueryResultCachedAudioInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_cached_audio")),
        #("value", encode_inline_query_result_cached_audio(inner_value)),
      ])
    }
    InlineQueryResultCachedDocumentInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_cached_document")),
        #("value", encode_inline_query_result_cached_document(inner_value)),
      ])
    }
    InlineQueryResultCachedGifInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_cached_gif")),
        #("value", encode_inline_query_result_cached_gif(inner_value)),
      ])
    }
    InlineQueryResultCachedMpeg4GifInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_cached_mpeg4_gif")),
        #("value", encode_inline_query_result_cached_mpeg4_gif(inner_value)),
      ])
    }
    InlineQueryResultCachedPhotoInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_cached_photo")),
        #("value", encode_inline_query_result_cached_photo(inner_value)),
      ])
    }
    InlineQueryResultCachedStickerInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_cached_sticker")),
        #("value", encode_inline_query_result_cached_sticker(inner_value)),
      ])
    }
    InlineQueryResultCachedVideoInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_cached_video")),
        #("value", encode_inline_query_result_cached_video(inner_value)),
      ])
    }
    InlineQueryResultCachedVoiceInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_cached_voice")),
        #("value", encode_inline_query_result_cached_voice(inner_value)),
      ])
    }
    InlineQueryResultArticleInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_article")),
        #("value", encode_inline_query_result_article(inner_value)),
      ])
    }
    InlineQueryResultAudioInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_audio")),
        #("value", encode_inline_query_result_audio(inner_value)),
      ])
    }
    InlineQueryResultContactInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_contact")),
        #("value", encode_inline_query_result_contact(inner_value)),
      ])
    }
    InlineQueryResultGameInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_game")),
        #("value", encode_inline_query_result_game(inner_value)),
      ])
    }
    InlineQueryResultDocumentInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_document")),
        #("value", encode_inline_query_result_document(inner_value)),
      ])
    }
    InlineQueryResultGifInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_gif")),
        #("value", encode_inline_query_result_gif(inner_value)),
      ])
    }
    InlineQueryResultLocationInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_location")),
        #("value", encode_inline_query_result_location(inner_value)),
      ])
    }
    InlineQueryResultMpeg4GifInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_mpeg4_gif")),
        #("value", encode_inline_query_result_mpeg4_gif(inner_value)),
      ])
    }
    InlineQueryResultPhotoInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_photo")),
        #("value", encode_inline_query_result_photo(inner_value)),
      ])
    }
    InlineQueryResultVenueInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_venue")),
        #("value", encode_inline_query_result_venue(inner_value)),
      ])
    }
    InlineQueryResultVideoInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_video")),
        #("value", encode_inline_query_result_video(inner_value)),
      ])
    }
    InlineQueryResultVoiceInlineQueryResult(inner_value) -> {
      json.object([
        #("type", json.string("inline_query_result_voice")),
        #("value", encode_inline_query_result_voice(inner_value)),
      ])
    }
  }
}
...
pub fn encode_input_message_content(value: InputMessageContent) -> Json {
  case value {
    InputTextMessageContentInputMessageContent(inner_value) -> {
      json.object([
        #("type", json.string("input_text_message_content")),
        #("value", encode_input_text_message_content(inner_value)),
      ])
    }
    InputLocationMessageContentInputMessageContent(inner_value) -> {
      json.object([
        #("type", json.string("input_location_message_content")),
        #("value", encode_input_location_message_content(inner_value)),
      ])
    }
    InputVenueMessageContentInputMessageContent(inner_value) -> {
      json.object([
        #("type", json.string("input_venue_message_content")),
        #("value", encode_input_venue_message_content(inner_value)),
      ])
    }
    InputContactMessageContentInputMessageContent(inner_value) -> {
      json.object([
        #("type", json.string("input_contact_message_content")),
        #("value", encode_input_contact_message_content(inner_value)),
      ])
    }
    InputInvoiceMessageContentInputMessageContent(inner_value) -> {
      json.object([
        #("type", json.string("input_invoice_message_content")),
        #("value", encode_input_invoice_message_content(inner_value)),
      ])
    }
  }
}
...
pub fn encode_revenue_withdrawal_state(value: RevenueWithdrawalState) -> Json {
  case value {
    RevenueWithdrawalStatePendingRevenueWithdrawalState(inner_value) -> {
      json.object([
        #("type", json.string("revenue_withdrawal_state_pending")),
        #("value", encode_revenue_withdrawal_state_pending(inner_value)),
      ])
    }
    RevenueWithdrawalStateSucceededRevenueWithdrawalState(inner_value) -> {
      json.object([
        #("type", json.string("revenue_withdrawal_state_succeeded")),
        #("value", encode_revenue_withdrawal_state_succeeded(inner_value)),
      ])
    }
    RevenueWithdrawalStateFailedRevenueWithdrawalState(inner_value) -> {
      json.object([
        #("type", json.string("revenue_withdrawal_state_failed")),
        #("value", encode_revenue_withdrawal_state_failed(inner_value)),
      ])
    }
  }
}
...
pub fn encode_transaction_partner(value: TransactionPartner) -> Json {
  case value {
    TransactionPartnerUserTransactionPartner(inner_value) -> {
      json.object([
        #("type", json.string("transaction_partner_user")),
        #("value", encode_transaction_partner_user(inner_value)),
      ])
    }
    TransactionPartnerChatTransactionPartner(inner_value) -> {
      json.object([
        #("type", json.string("transaction_partner_chat")),
        #("value", encode_transaction_partner_chat(inner_value)),
      ])
    }
    TransactionPartnerAffiliateProgramTransactionPartner(inner_value) -> {
      json.object([
        #("type", json.string("transaction_partner_affiliate_program")),
        #("value", encode_transaction_partner_affiliate_program(inner_value)),
      ])
    }
    TransactionPartnerFragmentTransactionPartner(inner_value) -> {
      json.object([
        #("type", json.string("transaction_partner_fragment")),
        #("value", encode_transaction_partner_fragment(inner_value)),
      ])
    }
    TransactionPartnerTelegramAdsTransactionPartner(inner_value) -> {
      json.object([
        #("type", json.string("transaction_partner_telegram_ads")),
        #("value", encode_transaction_partner_telegram_ads(inner_value)),
      ])
    }
    TransactionPartnerTelegramApiTransactionPartner(inner_value) -> {
      json.object([
        #("type", json.string("transaction_partner_telegram_api")),
        #("value", encode_transaction_partner_telegram_api(inner_value)),
      ])
    }
    TransactionPartnerOtherTransactionPartner(inner_value) -> {
      json.object([
        #("type", json.string("transaction_partner_other")),
        #("value", encode_transaction_partner_other(inner_value)),
      ])
    }
  }
}
...
pub fn encode_passport_element_error(value: PassportElementError) -> Json {
  case value {
    PassportElementErrorDataFieldPassportElementError(inner_value) -> {
      json.object([
        #("type", json.string("passport_element_error_data_field")),
        #("value", encode_passport_element_error_data_field(inner_value)),
      ])
    }
    PassportElementErrorFrontSidePassportElementError(inner_value) -> {
      json.object([
        #("type", json.string("passport_element_error_front_side")),
        #("value", encode_passport_element_error_front_side(inner_value)),
      ])
    }
    PassportElementErrorReverseSidePassportElementError(inner_value) -> {
      json.object([
        #("type", json.string("passport_element_error_reverse_side")),
        #("value", encode_passport_element_error_reverse_side(inner_value)),
      ])
    }
    PassportElementErrorSelfiePassportElementError(inner_value) -> {
      json.object([
        #("type", json.string("passport_element_error_selfie")),
        #("value", encode_passport_element_error_selfie(inner_value)),
      ])
    }
    PassportElementErrorFilePassportElementError(inner_value) -> {
      json.object([
        #("type", json.string("passport_element_error_file")),
        #("value", encode_passport_element_error_file(inner_value)),
      ])
    }
    PassportElementErrorFilesPassportElementError(inner_value) -> {
      json.object([
        #("type", json.string("passport_element_error_files")),
        #("value", encode_passport_element_error_files(inner_value)),
      ])
    }
    PassportElementErrorTranslationFilePassportElementError(inner_value) -> {
      json.object([
        #("type", json.string("passport_element_error_translation_file")),
        #("value", encode_passport_element_error_translation_file(inner_value)),
      ])
    }
    PassportElementErrorTranslationFilesPassportElementError(inner_value) -> {
      json.object([
        #("type", json.string("passport_element_error_translation_files")),
        #("value", encode_passport_element_error_translation_files(inner_value)),
      ])
    }
    PassportElementErrorUnspecifiedPassportElementError(inner_value) -> {
      json.object([
        #("type", json.string("passport_element_error_unspecified")),
        #("value", encode_passport_element_error_unspecified(inner_value)),
      ])
    }
  }
}
