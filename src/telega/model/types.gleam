...
pub type InputStoryContent {
  InputStoryContentPhotoInputStoryContent(InputStoryContentPhoto)
  InputStoryContentVideoInputStoryContent(InputStoryContentVideo)
}
...
pub type OwnedGift {
  OwnedGiftRegularOwnedGift(OwnedGiftRegular)
  OwnedGiftUniqueOwnedGift(OwnedGiftUnique)
}
...
pub type StoryAreaType {
  StoryAreaTypeLocationStoryAreaType(StoryAreaTypeLocation)
  StoryAreaTypeSuggestedReactionStoryAreaType(StoryAreaTypeSuggestedReaction)
  StoryAreaTypeLinkStoryAreaType(StoryAreaTypeLink)
  StoryAreaTypeWeatherStoryAreaType(StoryAreaTypeWeather)
  StoryAreaTypeUniqueGiftStoryAreaType(StoryAreaTypeUniqueGift)
}
...
/// **Official reference:** This object defines the criteria used to request suitable users. Information about the selected users will be shared with the bot when the corresponding button is pressed. More about requesting users: https://core.telegram.org/bots/features#chat-and-user-selection
...
/// **Official reference:** This object represents an incoming update. At most one of the optional fields can be present in any given update.
pub type Update {
  Update(
...
/// **Official reference:** This object represents a service message about a video chat started in the chat. Currently holds no information.
...
//
// Hand-written method-parameter types, their constructors, and the generic
// IntOrString / FileOrString types. The codegen tool (codegen/) preserves
// everything from the marker above to EOF.

// Union maintained by hand: the library accepts Location/Sticker/Venue media,
// which the canonical spec assigns to InputPollMedia / InputPollOptionMedia.
pub type InputMedia {
